...
public class Message {
	 ...
	 * Can only be set once externally.
	 */
	 ...
	 * @param outboundMsg The message to send
	 */
	public Message(String outboundMsg)
	{
	 ...
	 * @param responseMsg The response to be set
	 * @throws IllegalArgumentException	If this method is called once
	 * 	responseMsg has already been set
	 */
	public synchronized void setResponseMessage(String responseMsg) throws IllegalArgumentException
	{
	 ...
	 * @param responseMsgType	The new value of responseType
	 * @throws IllegalArgument 	If this method is called once responseType has
	 * 	already been set.
	 */
	public synchronized void setResponseType(ResponseType responseMsgType)
	{
