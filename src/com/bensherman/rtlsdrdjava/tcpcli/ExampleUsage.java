...
public class ExampleUsage {
	...
	public static void main(String[] args) throws Exception {
		...
		TcpClient tcpClient = new TcpClient("localhost", TcpClient.RTLSDRD_DEFAULT_TCP_PORT_NUMBER);
		
		// Create a new thread of the client
		Thread tcpClientThread = new Thread(tcpClient, TcpClient.getDefaultThreadName());
		
		// Start the TcpClient, reader, and writer threads
		tcpClientThread.start();
		
		// Write some strings to rtlsdrd
		for (String testMsg : TEST_MESSAGES)
		{
